...
public class CloudStorageHelper {
    ...
    static {
        ...
        try{
            serviceAccount = new ClassPathResource("imageupload-f5898-3b0f46088c50.json").getInputStream();
            storage = StorageOptions.newBuilder().setCredentials(GoogleCredentials.fromStream(serviceAccount)).setProjectId("imageupload-f5898").build().getService();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
